...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/template/default/images/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="/template/default/images/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="/template/default/images/ico/apple-touch-icon-72-precomposed.png">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.html"><img src="/template/default/images/home/inShop_mini.png" alt="inShop_logo" /></a>
                            </div>
                        </div>
                        <div class="col-sm-8">
